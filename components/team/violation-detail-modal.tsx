...
export function ViolationDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-[#111111] rounded-xl overflow-hidden mx-4 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="sticky top-0 bg-[#111111] border-b border-gray-800 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 font-mono">{violation.id}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)] p-6 space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <span className={getImpactBadgeClass(violation.ahrImpact)}>
              {violation.ahrImpact === 'High' && <AlertTriangle className="h-3.5 w-3.5 mr-1" />}
        ...
        {/* Footer */}
        <div className="sticky bottom-0 bg-[#111111] border-t border-gray-800 p-4 flex justify-end">
          <Button
            onClick={onClose}
            variant="outline"
